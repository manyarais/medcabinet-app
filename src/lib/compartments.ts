...
// The cabinet is one 5-bay perf-board unit driven by the CabinetLights ESP32:
...
/** 5 identical bays, numbered 1–5 to match the light strips. */
...
/** Currently unused — no dedicated scanner bay in the 5-slot layout. */
